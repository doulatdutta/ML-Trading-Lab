...
input double   InpBBWidthThreshold  = 0.25; // Squeeze Width Percentile
input double   InpATRSLMultiplier   = 2.0;         // Stop Loss ATR Multiple
input double   InpATRTPMultiplier   = 4.0;         // Take Profit ATR Multiple
...
input int      InpSmoothLen         = 50;        // Smoothing Length
input double   InpSmoothMult        = 2.5;       // EMA BB StdDev

input group "=== Squeeze & Slope ==="
input double   InpSqzThreshold      = 3.0;       // Squeeze Gap Threshold (Points)
